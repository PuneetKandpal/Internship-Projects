    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white rounded-lg shadow-lg p-8 flex">
        ...
        <div className="hidden md:flex flex-col justify-center w-1/2 bg-green-400 rounded-l-lg p-8 text-white">
          ...
          <p className="mt-2">
            Enter your email to reset your password and we'll send you the instructions.
          </p>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8">
          ...
          <form onSubmit={handleSubmit}>
            {/* Email Field */}
            <div className="mb-4">
              <label className="text-gray-600 flex items-center mb-2">
                <FaEnvelope className="mr-2" /> Email
              </label>
              <input
                type="email"
                className={`w-full text-black px-4 py-2 border ${error ? 'border-red-500' : 'border-gray-300'} rounded focus:outline-none focus:ring-2 focus:ring-green-500`}
                value={email}
