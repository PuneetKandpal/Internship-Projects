...
const AboutHero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-[45%] text-start md:text-left">
        <h2
          className={`animate-heading text-start md:text-start text-[13px] uppercase mb-1 font-Syne leading-4 font-normal ml-1 tracking-[.20em] ${
        ...
        <h1
          ...
          className="text-3xl text-start md:text-start md:text-5xl font-semibold mb-6 leading-[40px] md:leading-[3rem] font-Syne"
        >
          We Help You Accelerate Growth with Social Media
        </h1>
        <p
          ref={paragraphRef1}
          className={`mb-2 text-start md:text-start text-base md:text-[17px] font-normal leading-6 ${
        ...
        <p
          ref={paragraphRef2}
          className={`mb-6 text-start md:text-start text-base md:text-[17px] font-normal leading-6 ${
            theme === "light" ? "text-black/50" : "text-white/40"
          } font-Archivo`}
        >
