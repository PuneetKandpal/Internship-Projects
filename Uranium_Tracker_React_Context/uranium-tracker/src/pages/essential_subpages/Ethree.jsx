...
const Ethree = () => {
  const heading = "Global Distribution Of Uranium Resources";
  const subheading = (
    <>
      <p>
      ...
      <br />
      <p>
        The economic viability of Uranium deposits is determined by the grade of
        Uranium (measured in percentage of U3O8), the depth of the deposit, and
        the geological conditions that affect mining and extraction. High-grade
        deposits, such as those found in Canada's Athabasca Basin, are
        particularly valuable because they require less material to be processed
        to produce significant amounts of Uranium.
      </p>
    </>
  );
  ...
  return (
    <div>
      ...
      />
      <EssentialSubHero heading={heading} subheading={subheading} />

      {/* <!-- sec 1  --> */}
      <div className="w-full bg-zinc-800/30 sec-1 mt-0">
        <div className="px-6 md:px-20 py-10 md:py-20 mt-10">
          <h2 className="ml-0 flex items-center text-[1rem] md:text-[1.4rem] frank mb-4 md:mb-9 font-semibold text-white capitalize">
            <i className="ri-menu-4-fill text-lime2 font-bold text-xl mr-3"></i>
            major uranium producing countries
          </h2>

          <div className="mt-7 grid gap-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
            {/* <!-- Card 1 - Kazakhstan --> */}
            <div className="bg-cyan-900/10 rounded-sm p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex space-x-3">
                ...
                <h3 className="text-lg font-semibold mb-3 text-center frank text-cyan-200">
                  Kazakhstan
                </h3>
              </div>
              <ul className="space-y-2 text-sm text-cyan-100 list-disc ml-14">
                <li>
                  World's largest Uranium producer, contributing about 40% of
                  global production.
                </li>
                <li>Resources primarily in sandstone-hosted deposits.</li>
                <li>
                  Major operations include Inkai, South Inkai, and Central
                  Mynkuduk.
                </li>
                <li>Strategic partnerships with China and Russia.</li>
              </ul>
            </div>

            {/* <!-- Card 2 - Canada --> */}
            <div className="bg-red-900/10 rounded-sm p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex space-x-3">
                <div className="flex items-center justify-center mb-4">
                  {/* <!-- Icon --> */}
                  <svg
                ...
                <h3 className="text-lg font-semibold mb-3 text-center frank text-red-200">
                  Canada
                </h3>
              </div>
              <ul className="space-y-2 text-sm text-red-100 list-disc ml-14">
                <li>
                  Second-largest producer; known for exceptionally high-grade
                  Uranium deposits.
                </li>
                <li>Key Mines: McArthur River and Cigar Lake.</li>
                <li>Significant contributor to global Uranium supply.</li>
                <li>Export to countries with large nuclear programs.</li>
              </ul>
            </div>

            {/* <!-- Card 3 - Australia --> */}
            <div className="bg-blue-900/10 rounded-sm p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex space-x-3">
                <div className="flex items-center justify-center mb-4">
                  {/* <!-- Icon --> */}
                  <svg
                ...
                <h3 className="text-lg font-semibold mb-3 text-center frank text-blue-200">
                  Australia
                </h3>
              </div>
              <ul className="space-y-2 text-sm text-blue-100 list-disc ml-14">
                <li>
                  Holds the largest known recoverable Uranium resources
                  globally.
                </li>
                <li>
                  Notable deposits include Olympic Dam, Ranger, and Beverley
                  mines.
                </li>
                <li>Reliable supplier to vast resources.</li>
                <li>
                  Prohibits domestic nuclear power use but is a major Uranium
                  exporter.
                </li>
              </ul>
            </div>
            ...
            {/* <!-- Card 4 - Namibia --> */}
            <div className="bg-green-900/10 rounded-sm p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex space-x-3">
                <div className="flex items-center justify-center mb-4">
                  {/* <!-- Icon --> */}
                  <svg
                ...
                <h3 className="text-lg font-semibold mb-3 text-center frank text-green-200">
                  Namibia
                </h3>
              </div>
              <ul className="space-y-2 text-sm text-green-100 list-disc ml-14">
                <li>
                  Leading African producer; significant Uranium resources in the
                  Erongo Region.
                </li>
                <li>Key mines include Rössing and Husab.</li>
                <li>
                  Crucial for global supply, especially for countries
            ...
            {/* <!-- Card 5 - Niger --> */}
            <div className="bg-orange-900/10 rounded-sm p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex space-x-3">
                <div className="flex items-center justify-center mb-4">
                  {/* <!-- Icon --> */}
                  <svg
                ...
                <h3 className="text-lg font-semibold mb-3 text-center frank text-orange-200">
                  Niger
                </h3>
              </div>
              <ul className="space-y-2 text-sm text-orange-100 list-disc ml-14">
                <li>
                  Top African producer; major Uranium deposits in the Tim Mersoi
                  Basin.
                </li>
                <li>
                  Key deposits: Primarily sandstone-hosted, supplying
                  significant Uranium for France's nuclear power industry.
                </li>
                <li>
                  Key supplier to the global market, especially for Europe.
                </li>
              </ul>
            </div>

            {/* <!-- Card 6 - Russia --> */}
            <div className="bg-purple-900/10 rounded-sm p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex space-x-3">
                <div className="flex items-center justify-center mb-4">
                  {/* <!-- Icon --> */}
                  <svg
                ...
                <h3 className="text-lg font-semibold mb-3 text-center frank text-purple-200">
                  Russia
                </h3>
              </div>
              <ul className="space-y-2 text-sm text-purple-100 list-disc ml-14">
                <li>
                  Significant Uranium resources with production domestically and
                  through international mining operations.
                </li>
                <li>
                  State-owned Rosatom dominates the global nuclear industry.
                </li>
                <li>
                  Strong influence in the global Uranium market, especially in
            ...
            <div className="bg-red-900/10 rounded-sm p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <ul className="space-y-2 text-sm text-red-100 list-disc ml-14">
                <li>
                  Significant resources in western states like Wyoming, New
                  Mexico, and Texas.
                </li>
                <li>
                  Declining production but remains a significant global player.
                </li>
                <li>
                  Largest nuclear power industry, consuming a large portion of
                  global Uranium.
                </li>
              </ul>
            </div>
      ...
      <div className="px-6 md:px-20 py-10 md:py-20 mt-10">
        ...
        <div className="mt-7 grid gap-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1">
          {/* <!-- Card 1 - Uzbekistan --> */}
          <div className="bg-blue-900/10 rounded-sm p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex space-x-3">
              <div className="flex items-center justify-center mb-4">
            ...
            <ul className="space-y-2 text-sm text-cyan-100 list-disc ml-14">
              <li>
                Significant sandstone-hosted Uranium deposits, similar to
                Kazakhstan
              </li>
              <li>
                Navoi Mining & Metallurgy Combinat, a state-owned enterprise,
                operates multiple Uranium mines.
              </li>
              <li>Increasing output to meet growing global demand</li>
            </ul>
          </div>
          ...
          <div className="bg-green-900/10 rounded-sm p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <ul className="space-y-2 text-sm text-red-100 list-disc ml-14">
              <li>
                Significant Uranium resources, especially in the Lagoa Real
                region of Bahia.
              </li>
              <li>
                Current Uranium production is limited but with potential for
                growth.
              </li>
              <li>
                Ongoing exploration and development could increase Brazil's role
          ...
          {/* <!-- Card 3 - South Africa --> */}
          <div className="bg-red-800/5 rounded-sm p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex space-x-3">
              <div className="flex items-center justify-center mb-4">
                {/* <!-- Icon --> */}
                <svg
            ...
            <ul className="space-y-2 text-sm text-blue-100 list-disc ml-14">
              <li>
                Holds the largest known recoverable Uranium resources globally.
              </li>
              <li>
                Notable deposits include Olympic Dam, Ranger, and Beverley
                mines.
          ...
          {/* <!-- Card 4 - India -->  */}
          <div className="bg-[#865f17]/10 rounded-sm p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex space-x-3">
              <div className="flex items-center justify-center mb-4">
                {/* <!-- Icon --> */}
                <svg
            ...
            <ul className="space-y-2 text-sm text-green-100 list-disc ml-14">
              <li>
                Modest Resources: Relatively modest Uranium resources, including
                the Jaduguda mines in Jharkhand.
              </li>
              <li>
                Nuclear Expansion: Investing heavily in expanding nuclear power
                capacity
              </li>
              <li>
                Growing Demand: Increasing nuclear fuel demand may drive future
      ...
      <div className="w-full bg-zinc-800/30">
        <div className="px-6 md:px-20 py-10 md:py-24 mt-10">
          <h2 className="ml-0 flex items-center text-[1rem] md:text-[1.4rem] frank mb-4 md:mb-2 font-semibold text-white capitalize">
            <i className="ri-menu-4-fill text-lime2 font-bold text-xl mr-3"></i>
            Geopolitical and economic implications of uranium distribution
          </h2>

          <p className="lato text-white/40 mt- ml-1">
            The global distribution of Uranium resources has significant
            geopolitical and economic implications, influencing international
            relations, trade policies, and market dynamics.
          </p>

          <div className="container mx-auto mt-12">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
              <div className="bg-zinc-800/30 shadow-sm rounded-sm p-6">
                <div className="flex items-center space-x-3 mb-3">
                  <i className="fas fa-shield-alt text-lime2 text-[17px]"></i>
                  <h2 className="text-white frank text-xl font-semibold ml-2">
                    Supply Security and Strategic Reserves
                  </h2>
                </div>
                <p className="text-white/60 leading-relaxed text-[16px] font-light ml-7">
                  Countries with large nuclear programs secure Uranium through
                  long-term contracts, strategic reserves, and foreign
                  investments. Those lacking domestic resources rely heavily on
                  imports, making them vulnerable to supply disruptions and
                  price fluctuations.
                </p>
              </div>
              ...
              <div className="bg-zinc-800/30 shadow-sm rounded-sm p-6">
                <div className="flex items-center space-x-3 mb-3">
                  <i className="fas fa-chart-bar text-lime2 text-[17px]"></i>
                  <h2 className="text-white frank text-xl font-semibold ml-2">
                    Market Dynamics and Pricing
                  </h2>
                </div>
                <p className="text-white/60 leading-relaxed text-[16px] font-light ml-7">
                  The concentration of Uranium production in a few countries,
                  like Kazakhstan, Canada, and Australia, enables them to
                  influence global prices through production levels and export
                  policies. This creates a complex and volatile market shaped by
              ...
              <div className="bg-zinc-800/30 shadow-sm rounded-sm p-6">
                <div className="flex items-center space-x-3 mb-3">
                  <i className="fas fa-globe text-lime2 text-[17px]"></i>
                  <h2 className="text-white frank text-xl font-semibold ml-2">
                    Geopolitical Tensions and Resource Competition
                  </h2>
                </div>
                <p className="text-white/60 leading-relaxed text-[16px] font-light ml-7">
                  Competition for Uranium resources can heighten geopolitical
                  tensions, especially in unstable regions. Strategic alliances,
                  investments, and diplomacy are used to secure access, making
                  Uranium distribution key in international relations.
                </p>
              </div>

              <div className="bg-zinc-800/30 shadow-sm rounded-sm p-6">
                <div className="flex items-center space-x-3 mb-3">
                  <i className="fas fa-leaf text-lime2 text-[17px]"></i>
                  <h2 className="text-white frank text-xl font-semibold ml-2">
                    Environmental and Regulatory Considerations
                  </h2>
                </div>
                <p className="text-white/60 leading-relaxed text-[16px] font-light ml-7">
                  The environmental impact of Uranium mining and waste
                  management is a major concern. Countries like Canada and
                  Australia use advanced practices to minimize their footprint,
                  with strict regulations affecting production costs and global
                  competitiveness.
                </p>
              </div>
            </div>
