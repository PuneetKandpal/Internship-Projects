        ...
        <div className="component-uranium" id="uranium-stocks">
          <table className="w-full uranium-stocks-table min-w-[600px]">
            <thead className="bg-bg text-white/30 border-b border-white/10">
              <tr>
                <th className="px-2 py-2 md:px-4 md:py-[11px] text-left text-[10px] md:text-[11px] font-medium uppercase tracking-wider">
                  Country
                </th>
                <th className="px-2 py-2 md:px-4 md:py-[11px] text-left text-[10px] md:text-[11px] font-medium uppercase tracking-wider">
                  Symbol
            ...
            <tbody className="bg-bg text-gray-300">
              {tableData.map((row, index) => (
                ...
                >
                  <td className="px-4 py-[11px]">{row.country}</td>
                  <td className="px-4 py-[11px] font-semibold">{row.symbol}</td>
                  <td className="px-4 py-[11px]">{row.name}</td>
                  <td className="px-4 py-[11px]">{row.currentPrice}</td>
                  <td className="px-4 py-[11px]">{row.lastPrice}</td>
                  <td
                    className={`px-4 py-[11px] ${getColorClass(row.return1M)}`}
                  >
                    {row.return1M}
                  </td>
                  <td
                    className={`px-4 py-[11px] ${getColorClass(
                      row.returnDaily
                    )}`}
                  >
                    {row.returnDaily}
                  </td>
                  <td className="px-4 py-[11px]">{row.volumeDaily}</td>
                </tr>
              ))}
            </tbody>
          </table>
